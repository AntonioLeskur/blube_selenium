...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Korisnik\Desktop\selenium_project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Korisnik\Desktop\selenium_project\venv\Scripts\deactivate.nu'
